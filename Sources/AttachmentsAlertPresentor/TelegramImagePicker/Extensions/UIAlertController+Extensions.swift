...
extension UIAlertController {
    func addTelegramPicker(_ delegate: TelegramPickerDelegate, _ attachmentSource: [AttachmentSource]) {
        let vc = TelegramPickerViewController(delegate, attachmentSource)
        set(vc: vc)
    }
}
